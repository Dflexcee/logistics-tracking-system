...
$stmt->bind_param("ii", $consignment_id, $_SESSION['user_id']);
$stmt->execute();
...
<head>
    ...
    <title>View Consignment - Agent Dashboard</title>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-2">
                        <a href="edit-consignment.php?id=<?php echo $consignment_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700">
                            <i class="fas fa-edit mr-2"></i> Edit
                        </a>
                        <a href="update-status.php?id=<?php echo $consignment_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                            <i class="fas fa-truck mr-2"></i> Update Status
                        </a>
                        <a href="print.php?id=<?php echo $consignment_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700" target="_blank">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm font-medium"><?php echo htmlspecialchars($consignment['description'] ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium"><?php echo htmlspecialchars($consignment['package_type'] ?? 'N/A'); ?></p>
                                </div>
